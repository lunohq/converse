...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleOAuthResponse = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(req, res) {
      var _req$query, code, signedState, state, api, auth, userDetails, _userDetails, _userDetails$user, userId, userEmail, userName, _userDetails$team, teamId, teamName, teamDomain, team, isNew, scopes, user;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 37:
              ...
              debug('Saving team', { team: team, isNew: isNew });
              _context4.next = 44;
            ...
            case 50:
              ...
              debug('Saving user', { user: user, isNew: isNew });
              _context4.next = 58;
