...
var Server = function (_EventEmitter) {
  ...
  function Server(config) {
    ...
    var isNewUser = config.isNewUser;
    ...
    _this.isNewUser = isNewUser || defaultIsNewUser;
    _this.validate();
    return _this;
  }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleOAuthResponse = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(req, res) {
      var _req$query, code, signedState, state, api, auth, authDetails, _authDetails, userDetails, teamDetails, isNew, team, id, rest, scopes, user, isNewUser, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, key;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 32:
              ...
              debug('Checking for new token', { team: team, auth: auth });
            ...
            case 46:
              user = _context4.sent;
              _context4.next = 49;
              return _this3.isNewUser(user);

            case 49:
              isNewUser = _context4.sent;
      ...
      }, _callee4, _this3, [[54, 58, 62, 70], [63,, 65, 69]]);
    }));
