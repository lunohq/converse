...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleOAuthResponse = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(req, res) {
      var _req$query, code, signedState, state, api, auth, authDetails, _authDetails, userDetails, teamDetails, isNew, team, id, rest, scopes, user, _id, _rest;
          ...
          switch (_context4.prev = _context4.next) {
            ...
            case 45:
              ...
              if (!user) {
                isNew.user = true;
                _id = userDetails.id;
                _rest = (0, _objectWithoutProperties3.default)(userDetails, ['id']);
