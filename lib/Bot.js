...
exports.WS_ERROR = exports.UNABLE_TO_RTM_START = exports.CONNECTED = exports.DISCONNECT = undefined;
...
var UNABLE_TO_RTM_START = exports.UNABLE_TO_RTM_START = _client.CLIENT_EVENTS.RTM.UNABLE_TO_RTM_START;
...
var Bot = function (_Emitter) {
  ...
  (0, _createClass3.default)(Bot, [{
    ...
    value: function start() {
      ...
      this.rtm.on(_client.CLIENT_EVENTS.RTM.UNABLE_TO_RTM_START, function (message) {
        _this2.connected = false;
        _this2.emit(UNABLE_TO_RTM_START, new Error(message));
      });
