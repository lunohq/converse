...
var DISCONNECT = exports.DISCONNECT = _client.RTM_EVENTS.DISCONNECT;
...
var Bot = function (_Emitter) {
  ...
  function Bot(config) {
    ...
    _this.rtm = new _client.RtmClient(_this.team.token, config.rtm);
  ...
  (0, _createClass3.default)(Bot, [{
    ...
    value: function start() {
      ...
      this.rtm.on(_client.RTM_EVENTS.DISCONNECT, function () {
        return _this2.emit(DISCONNECT);
      });
      this.rtm.on(_client.RTM_EVENTS.WS_ERROR, function () {
        return _this2.emit(DISCONNECT);
      });
      this.rtm.on(_client.RTM_EVENTS.WS_CLOSE, function () {
        return _this2.emit(DISCONNECT);
      });
    }
  }, {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              return _context.abrupt('return', _this3.middleware.sent.run({ ctx: ctx, message: message, source: source, response: response }));
