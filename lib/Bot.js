...
exports.AUTHENTICATED = exports.DISCONNECT = undefined;
...
var AUTHENTICATED = exports.AUTHENTICATED = _client.CLIENT_EVENTS.RTM.AUTHENTICATED;
  ...
  (0, _createClass3.default)(Bot, [{
    ...
    value: function start() {
      ...
      this.rtm.on(_client.CLIENT_EVENTS.RTM.DISCONNECT, function (err, code) {
        return _this2.emit(DISCONNECT, err, code);
      });
