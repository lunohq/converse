...
var Bot = function (_Emitter) {
  ...
  (0, _createClass3.default)(Bot, [{
    ...
    value: function start() {
      ...
      this.rtm.on(_client.CLIENT_EVENTS.RTM.DISCONNECT, function () {
        return _this2.emit(DISCONNECT);
      });
      this.rtm.on(_client.CLIENT_EVENTS.RTM.WS_ERROR, function () {
        return _this2.emit(DISCONNECT);
      });
      this.rtm.on(_client.CLIENT_EVENTS.RTM.WS_CLOSE, function () {
        return _this2.emit(DISCONNECT);
      });
      this.rtm.on(_client.CLIENT_EVENTS.RTM.AUTHENTICATED, function () {
